...
public class Signup extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (username.isEmpty() || firstname.isEmpty() || lastname.isEmpty() || password.isEmpty() || email.isEmpty() || work_place.isEmpty()) {
                ...
                String s = "insert into user(`id`, `username`, `name`, `email`, `password_hash`, `level`, `workspace`, `created_at`) values(NULL,'" + username + "','" + name + "','" + email + "','" + password + "',1,'" + work_place + "',NULL)";
                out.print(s);
